...
class SearchParams():
    ...
    def __post_init__(self):
        self._fields = self.fields or FieldsSearchParam()
        self._functions = self.functions or FunctionsSearchParam()
        self._models = self.models or ModelsSearchParam()
        self._purposes = self.purposes or PurposesSearchParam()
